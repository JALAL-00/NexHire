...
const scrape_jobs_dto_1 = require("./dto/scrape-jobs.dto");
...
let ScraperController = class ScraperController {
    ...
    async scrapeJobs(scrapeJobsDto, req) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Scrape jobs from various platforms (authenticated)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of scraped jobs' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Invalid request' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [scrape_jobs_dto_1.ScrapeJobsDto, Object]),
    __metadata("design:returntype", Promise)
], ScraperController.prototype, "scrapeJobs", null);
