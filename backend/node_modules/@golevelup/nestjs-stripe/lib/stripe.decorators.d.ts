 ...
 */
export declare const InjectStripeModuleConfig: () => PropertyDecorator & ParameterDecorator;
/**
 * Injects the Stripe Client instance
 */
export declare const InjectStripeClient: () => PropertyDecorator & ParameterDecorator;
/**
 ...
 */
export declare const StripeWebhookHandler: (eventType: Stripe.WebhookEndpointCreateParams.EnabledEvent) => import("@nestjs/common").CustomDecorator<typeof STRIPE_WEBHOOK_HANDLER>;
