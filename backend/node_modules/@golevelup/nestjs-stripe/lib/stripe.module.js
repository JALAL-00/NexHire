...
let StripeModule = StripeModule_1 = class StripeModule extends stripe_module_definition_1.ConfigurableModuleClass {
    ...
    async onModuleInit() {
        ...
        const noOneSecretProvided = this.stripeModuleConfig.webhookConfig &&
            !((_a = this.stripeModuleConfig.webhookConfig) === null || _a === void 0 ? void 0 : _a.stripeSecrets.account) &&
            !((_b = this.stripeModuleConfig.webhookConfig) === null || _b === void 0 ? void 0 : _b.stripeSecrets.accountTest) &&
            !((_c = this.stripeModuleConfig.webhookConfig) === null || _c === void 0 ? void 0 : _c.stripeSecrets.connect) &&
            !((_d = this.stripeModuleConfig.webhookConfig) === null || _d === void 0 ? void 0 : _d.stripeSecrets.connectTest);
        ...
        const webhookHandlers = (0, lodash_1.flatten)(Object.keys(grouped).map((x) => {
            ...
            return grouped[x].map(({ discoveredMethod, meta: eventType }) => ({
                ...
                undefined, // options
                stripe_constants_1.STRIPE_WEBHOOK_CONTEXT_TYPE),
            }));
        }));
        ...
        providers: [
            {
                ...
                inject: [stripe_module_definition_1.MODULE_OPTIONS_TOKEN],
                useFactory: (config) => {
                    var _a, _b, _c;
            ...
            },
            {
                ...
                inject: [stripe_module_definition_1.MODULE_OPTIONS_TOKEN],
                useFactory: (_a) => {
                    var { apiKey, typescript = true, apiVersion = '2025-03-31.basil' } = _a, options = __rest(_a, ["apiKey", "typescript", "apiVersion"]);
                    return new stripe_1.default(apiKey, Object.assign({ typescript,
                        apiVersion }, (0, lodash_1.omit)(options, ['webhookConfig'])));
                },
            },
            stripe_webhook_service_1.StripeWebhookService,
            stripe_payload_service_1.StripePayloadService,
        ],
        exports: [stripe_constants_1.STRIPE_CLIENT_TOKEN],
    }),
